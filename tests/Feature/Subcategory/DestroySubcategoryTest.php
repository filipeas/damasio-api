...
class DestroySubcategoryTest extends TestCase
{
     ...
     * @group Subcategory
     */
    public function excluindoSubcategoriaCadastrada()
    {
     ...
     * @group Subcategory
     */
    public function excluindoCategoriaComSubcategoriaCadastrada()
    {
        $this->artisan('passport:install');

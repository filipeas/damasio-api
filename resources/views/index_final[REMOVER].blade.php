    ...
    <style>
        ...
        * {
        ...
        .espacamento_tabela_2{
            font-family: 'swis721_cn_bt' !important;
            font-weight: bold;
            margin-top: 171px; /** 170 */
            width: 210px;
        }
        /* .espacamento_tabela_3{
            margin-top: 170px;
            width: 210px;
        }
        .espacamento_tabela_4{
            margin-top: 170px;
            width: 210px;
        }
        .espacamento_tabela_5{
            margin-top: 171px;
            width: 210px;
        } */
...
<body>
    ...
    <!-- titulo da categoria no inicio da pagina -->
    @if($line == 1)
        ...
        <?php
            ...
            if ($alturaConteudo > 60 && $line == 10){
                if ((770 + $alturaConteudo - 30) > 770){
                    ...
                    @foreach($categories_column as $key => $category_selected)
                        <div class="{{ $key == 0 ? 'espacamento_tabela_1' : 'espacamento_tabela_2' }} {{ ($pageNumber % 2 == 0 ? 'espacamento_esquerda' : 'espacamento_direita') }}" style="{{ ($category_selected['marked'] ? 'color: #fff; background-color: #' . $category_selected['color'] . ';' : '') }}">{{$category_selected['category']}}</div>
                    @endforeach

...
@section('content')
    ...
    <section id="box-top" class="jumbotron text-center">
        <div class="container">
            ...
            <a href="{{ route('site.subcategory', ['subcategory' => $product->subcategory->id, 'page' => 1]) }}" class="m-5 btn btn-lg btn-outline-primary">Voltar para a subcategoria {{ $product->subcategory->title }}</a>
        </div>
    </section>
